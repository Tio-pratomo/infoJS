...
Bayangkan aplikasi Anda sebagai etalase toko online. Saat pelanggan ingin melihat daftar produk atau memproses pembayaran, **_aplikasi perlu bertukar informasi dengan server_**.

Di dunia pemrograman, pertukaran informasi ini dilakukan melalui **HTTP Request**. **Axios** berperan sebagai **_kurir handal_** yang menyederhanakan proses pengiriman permintaan (**request**) dan penerimaan jawaban (**response**) data antara aplikasi dan server Anda
